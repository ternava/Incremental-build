...
def spec_to_array():
    #for variant in glob.glob("/home/xternava/Documents/GitHub/Incremental-build/curl-sample-configurations/sample-01/*.config"):
    for variant in glob.glob("/src/curl-sample-configurations/sample-01/*.config"):
