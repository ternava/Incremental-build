...
def spec_to_array():
    #for variant in glob.glob("/home/xternava/Documents/GitHub/Incremental-build/sqlite-sample-configurations/sample-01/*.config"):
    for variant in glob.glob("/src/sqlite-sample-configurations/sample-01/*.config"):
